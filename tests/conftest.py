...
SAMPLE_SERVER_POLICY = {
    ...
    "localPubkey": "SVRpubkeyTESTxxxxxxxxxxxxxxxxxxxxxxxxxxx0=",
    "localDns": ["8.8.8.8"],
    "clientlist": [
        {
            "uuid": "peer_uuid_001",
        ...
        },
        {
            ...
            "desc": "Site Beta",
            "ipaddr": "10.100.0.103",
            "peerPubkey": "PERpubkeyTESTxxxxxxxxxxxxxxxxxxxxxxxxxxx0=",
            "presharedkey": "PSK000002TESTxxxxxxxxxxxxxxxxxxxxxxxxxxx0=",
            "allowips": ["10.100.0.103/32"],
        },
    ],
}
...
SAMPLE_CLIENT_POLICY = {
    ...
    "localPubkey": "STEpubkeyTESTxxxxxxxxxxxxxxxxxxxxxxxxxxx0=",
    "peerPubkey": "SVRpubkeyTESTxxxxxxxxxxxxxxxxxxxxxxxxxxx0=",
    "presharedkey": "PSK000001TESTxxxxxxxxxxxxxxxxxxxxxxxxxxx0=",
    "localDns": ["8.8.8.8"],
    "priority": [],
    "strictPriority": "0",
