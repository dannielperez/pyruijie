"""Integration-pattern tests — mirrors how downstream application consumes pyruijie.
...
found in the downstream application codebase.
"""
...
class TestExceptionHierarchy:
    """downstream application catches RuijieError broadly and subtypes specifically."""
...
class TestFormatMacIntegration:
    """downstream application normalize_mac() duplicates format_mac(); verify equivalence."""
