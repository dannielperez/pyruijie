...
class TestOnboardingResult:
    def test_success_summary(self):
        r = OnboardingResult(
            site_name="Test Site", success=True, peer_ip="10.0.0.50"
        )
...
class TestWireGuardSiteLink:
    def test_fields(self):
        link = WireGuardSiteLink(
            host="***REMOVED***", role="hub", peer_ip="10.0.0.50",
            pubkey="abc123==", policy_uuid="uuid-1", policy_name="WG_CLIENT"
        )
...
class TestPeersRemove:
    ...
    def test_remove_with_yes(self, mock_dotenv, mock_creds, mock_connect, capsys):
        ...
        main(["peers", "remove", "--ip", "10.0.0.105", "-y"])
